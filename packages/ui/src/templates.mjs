...
/** @typedef {{ homeHref?: string, leadingActions?: string, navigation?: string }} HeaderOptions */
...
export function olaInkHeader(options = {}) {
  const { homeHref = '/', leadingActions = '', navigation = '' } = options;
  ...
  return `<header class="olaink-header">${leading}<a class="olaink-brand" href="${escapeAttribute(homeHref)}" aria-label="Ola Ink home"><span>Ola Ink</span></a>${nav}</header>`;
}
