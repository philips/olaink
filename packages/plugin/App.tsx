/** Ola Ink Share plugin view: launches the companion; it never handles note data. */
  ...
  return (
    <View style={styles.root}>
      <View style={styles.header}>
        ...
        <Text style={styles.title}>Ola Ink Share</Text>
      </View>
      <View style={styles.body}>
        <Text style={styles.copy}>Ola Ink encrypts and plays complete note files in the companion app.</Text>
